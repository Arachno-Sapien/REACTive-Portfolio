...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  return (
    <div
      ref={wrapRef}
      className={`relative touch-none mx-auto w-full max-w-[380px] flex justify-center ${className}`.trim()}
    ...
    >
      ...
      <div ref={shellRef} className="relative z-[1] group w-full flex justify-center">
        <section
          className="grid relative overflow-hidden mx-auto w-full"
          style={{
            width: '100%',
            maxWidth: '380px',
            aspectRatio: '0.718',
            maxHeight: 'min(80svh, 540px)',
        ...
        >
          ...
          >
            {/* Avatar content - original image displayed cleanly with zero filters/tints */}
            <div
            ...
            >
              ...
              {showUserInfo && (
                <div
                  className="absolute z-[10] flex items-center justify-between backdrop-blur-[24px] border border-white/15 pointer-events-auto shadow-lg"
                  style={
                    {
                      '--ui-inset': '16px',
                      '--ui-radius-bias': '6px',
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col items-start gap-1">
                      <div className="text-sm font-semibold text-paper leading-none">@{handle}</div>
                      <div className="text-xs text-mint leading-none flex items-center gap-1.5">
                  ...
                  <button
                    className="border border-mint/40 rounded-xl px-3.5 py-2 text-xs font-semibold text-mint bg-mint/10 cursor-pointer backdrop-blur-[10px] transition-all duration-200 ease-out hover:bg-mint hover:text-ink hover:-translate-y-px"
            ...
            >
              {/* Subtle top vignette for crystal clear text contrast without altering avatar */}
              <div
                className="absolute inset-x-0 top-0 h-40 pointer-events-none"
                style={{
                  background: 'linear-gradient(to bottom, rgba(5, 7, 10, 0.75) 0%, rgba(5, 7, 10, 0.3) 55%, transparent 100%)',
                  borderRadius: `${cardRadius} ${cardRadius} 0 0`
                }}
              />
              <div className="w-full absolute flex flex-col px-4" style={{ top: '1.6rem', display: 'flex', gridArea: 'auto' }}>
                <h3
                  className="font-display font-bold m-0 tracking-tight text-paper drop-shadow-md"
                  style={{
                ...
                <p
                  className="font-medium whitespace-nowrap mx-auto drop-shadow-sm"
                  style={{
                    position: 'relative',
                    fontSize: '13px',
                    margin: '4px auto 0',
